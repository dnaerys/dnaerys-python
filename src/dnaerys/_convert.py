...
def convert_variant(proto: pb2.Variant) -> Variant:
    ...
    return Variant(
        ...
        ac=proto.ac,
        an=proto.an,
        hom_samples=proto.hom_samples,
        het_samples=proto.het_samples,
        mis_samples=proto.mis_samples,
        hom_samples_fx=proto.hom_samples_fx,
        het_samples_fx=proto.het_samples_fx,
        mis_samples_fx=proto.mis_samples_fx,
        hom_samples_mxy=proto.hom_samples_mxy,
        het_samples_mxy=proto.het_samples_mxy,
        mis_samples_mxy=proto.mis_samples_mxy,
...
def convert_variant_with_stats(proto: pb2.VariantWithStats) -> VariantWithStats:
    ...
    return VariantWithStats(
        ...
        vac=proto.vac,
        van=proto.van,
        v_hom_samples=proto.v_hom_samples,
        v_het_samples=proto.v_het_samples,
        v_hom_samples_fx=proto.v_hom_samples_fx,
        v_het_samples_fx=proto.v_het_samples_fx,
        v_hom_samples_mxy=proto.v_hom_samples_mxy,
        v_het_samples_mxy=proto.v_het_samples_mxy,
        phwe=proto.phwe,
        pchi2=proto.pchi2,
...
def convert_dataset_info_response(proto: pb2.DatasetInfoResponse) -> DatasetInfo:
    ...
    return DatasetInfo(
        ...
        elapsed_ms=int(proto.elapsed_ms),
        node_id=proto.node_id,
        max_variants_per_ring=proto.max_variants_per_ring,
    )
